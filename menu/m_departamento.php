            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                   ...
                   <li>
                    ...
                    <li>
                        <a class="active-menu" href="#"><i class="fa fa-cog fa-3x"></i> Administracion<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
							...
							<li>
                                <a href="../tarifas/index.php"> Tarifas</a>
                            </li>
                            <li>
                                <a href="../seguros/index.php"> Seguros</a>
                            </li>
                            <!--<li>
